...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User.insert(user1.getId(), user1.getUsername(), user1.getPassword(), user1.getEmail(), user1.getPhoneNumber(), user1.getAddress(), user1.getWallet(), user1.getCarts().keySet(), user1.getOrders().keySet(), user1.getWalletRequests().keySet(), user1.getPurchasedProducts().keySet());
        runMenu(shop);
    }
    ...
    public static void runMenu(Shop shop) {
        ...
        switch (optionMenu) {
            case 1 -> {
                ...
                Seller.insert(newSeller.getId(), newSeller.getCompanyName(), newSeller.getPassword(), newSeller.getAvailableProducts().keySet(), newSeller.getWallet(), newSeller.isAuthorized());
                runMenu(shop);
            }
            case 2 -> {
                //Sign up a user
            ...
            case 2 -> {
                ...
                switch (optionMenu) {
                    case 1 -> {
                        ...
                        ShoppingCart.insert(newShoppingCart.getName(), newShoppingCart.getCartID(), newShoppingCart.getUserID(), newShoppingCart.getTotalPrice(), newShoppingCart.hasCheckout(), newShoppingCart.getItemNumber());
                    }
                    case 2 -> {
                    ...
                    case 5 -> {
                        ...
                        if (!shop.hasCheckout(UUID.fromString(productID))){
                            ...
                            Order newOrder = new Order(cart.getName(), cart.getProducts(), cart.getItemNumber(), cart.getTotalPrice(), shop.getCurrentAccount().getId());
                            shop.addOrder(newOrder);
                            Order.insert(newOrder.getDate(), newOrder.getDateTimeFormatter(), newOrder.getBuyerID(), newOrder.getOrderID(), newOrder.isConfirmed());
                        }
                    }
                    default -> throw new IllegalStateException("Unexpected value: " + optionMenu);
                }
            ...
            case 3 -> {
                ...
                switch (optionMenu) {
                    case 1 -> {
                        ...
                        input.nextLine();
                        WalletReq newWalletReq = new WalletReq(value, shop.getCurrentAccount().getId());
                        shop.submitAWalletRequest(newWalletReq);
                        WalletReq.insert(newWalletReq.getValue(), newWalletReq.getUser(), newWalletReq.getWalletID(), newWalletReq.isConfirmed());
                    }
                    case 2 -> {
                        System.out.println("""
                            ...
                            case 1 -> {
                                ...
                                switch (optionMenu) {
                                    ...
                                    case 2 -> {
                                        ...
                                        EyeMakeUp.insert(eyeMakeUp.getProductID(), eyeMakeUp.getName(), eyeMakeUp.getColor(), eyeMakeUp.getPrice(), eyeMakeUp.getSellerId(), eyeMakeUp.getQuantity(), eyeMakeUp.getComments(), eyeMakeUp.getMaterialState(), eyeMakeUp.isHasBox(), eyeMakeUp.getPenType(), eyeMakeUp.isHasWaterResistance(), eyeMakeUp.getBrand(), eyeMakeUp.getLongevity());
                                    }
                                }
                            }
                            case 2 -> {
                                ...
                                switch (optionMenu) {
                                    ...
                                    case 2 -> {
                                        ...
                                        Children_Book.insert(children_book.getProductID(), children_book.getName(), children_book.getColor(), children_book.getPrice(), children_book.getSellerId(), children_book.getQuantity(), children_book.getComments(), children_book.getISBN(), children_book.getPageNumbers(), children_book.getAuthor(), children_book.getLanguage(), children_book.getReadingLevel(), children_book.getTheme());
                                    }
                                    case 3 -> {
                                        System.out.println("""
                                                9- Poetic Form
                            ...
                            case 3 -> {
                                ...
                                switch (optionMenu) {
                                    case 1 -> {
                                        ...
                                        Coat.insert(coat.getProductID(), coat.getName(), coat.getColor(), coat.getPrice(), coat.getSellerId(), coat.getQuantity(), coat.getComments(), coat.getSize(), coat.getGender(), coat.getMaterial(), coat.getBrand(), coat.getDurability(), coat.getButtonNumber(), coat.isHasCap());
                                    }
                                    case 2 -> {
                                        System.out.println("""
                                                Enter :
                                        ...
                                        Jean.insert(jean.getProductID(), jean.getName(), jean.getColor(), jean.getPrice(), jean.getSellerId(), jean.getQuantity(), jean.getComments(), jean.getSize(), jean.getGender(), jean.getMaterial(), jean.getBrand(), jean.getDurability(), jean.getHeight(), jean.getPocketNumber(), jean.isHasZipper());
                                    }
                                    case 3 -> {
                                        System.out.println("""
                                                Enter :
                                        ...
                                        Sweater.insert(sweater.getProductID(), sweater.getName(), sweater.getColor(), sweater.getPrice(), sweater.getSellerId(), sweater.getQuantity(), sweater.getComments(), sweater.getSize(), sweater.getGender(), sweater.getMaterial(), sweater.getBrand(), sweater.getDurability(), sweater.getButtonNumber(), sweater.getDesign());
                                    }
                                }
                            }
                            case 4 -> {
                                ...
                                switch (optionMenu) {
                                    ...
                                    case 3 -> {
                                        ...
                                        SmartWatch.insert(smartWatch.getProductID(), smartWatch.getName(), smartWatch.getColor(), smartWatch.getPrice(), smartWatch.getSellerId(), smartWatch.getQuantity(), smartWatch.getComments(), smartWatch.getBrand(), smartWatch.getModel(), smartWatch.getOS(), smartWatch.getScreenSize(), smartWatch.getBatteryCapacity(), smartWatch.isHasHeartRateTracker(), smartWatch.isHasStepTracker(), smartWatch.isHasCaloricTracker());
                                    }
                                }
                            }
                            case 5 -> {
                                ...
                                switch (optionMenu) {
                                    ...
                                    case 2 -> {
                                        ...
                                        Refrigerator.insert(refrigerator.getProductID(), refrigerator.getName(), refrigerator.getColor(), refrigerator.getPrice(), refrigerator.getSellerId(), refrigerator.getQuantity(), refrigerator.getComments(), refrigerator.isHasController(), refrigerator.getHeight(), refrigerator.getWidth(), refrigerator.getWeight(), refrigerator.getFloorNumber(), refrigerator.isHasFridge(), refrigerator.getRefrigeratorType(), refrigerator.isHasDigitalControllingSystem());
                                    }
                                    case 3 -> {
                                        System.out.println("""
                                                Enter :
                                        ...
                                        shop.addProduct(tv);
                                        TV.insert(tv.getProductID(), tv.getName(), tv.getColor(), tv.getPrice(), tv.getSellerId(), tv.getQuantity(), tv.getComments(), tv.isHasController(), tv.getHeight(), tv.getWidth(), tv.getWeight(), tv.getRefreshRate(), tv.isMountableOnWall(), tv.isHas3D(), tv.isHasStand());
                                    }
                                }
                            }
                            case 6 -> {
                                ...
                                switch (optionMenu) {
                                    case 1 -> {
                                        ...
                                        Ball.insert(ball.getProductID(), ball.getName(), ball.getColor(), ball.getPrice(), ball.getSellerId(), ball.getQuantity(), ball.getComments(), ball.getWeight(), ball.getSportType(), ball.getBrand(), ball.getSize(), ball.getMaterial(), ball.isRightHandOriented());
                                    }
                                    case 2 -> {
                                        System.out.println("""
                                                Enter :
                                        ...
                                        Gloves.insert(glove.getProductID(), glove.getName(), glove.getColor(), glove.getPrice(), glove.getSellerId(), glove.getQuantity(), glove.getComments(), glove.getWeight(), glove.getSportType(), glove.getBrand(), glove.getMaterial(), glove.getSize(), glove.getSuggestedUser(), glove.getStyle());
                                    }
                                    case 3 -> {
                                        System.out.println("""
                                                Enter :
                                        ...
                                        Rackets.insert(racket.getProductID(), racket.getName(), racket.getColor(), racket.getPrice(), racket.getSellerId(), racket.getQuantity(), racket.getComments(), racket.getWeight(), racket.getSportType(), racket.getBrand(), racket.getLength(), racket.getWidth(), racket.getDurability(), racket.getShape());
                                    }
                                }
                            }
                            case 7 -> {
                                ...
                                switch (optionMenu) {
                                    ...
                                    case 3 -> {
                                        ...
                                        Proteins.insert(protein.getProductID(), protein.getName(), protein.getColor(), protein.getPrice(), protein.getSellerId(), protein.getQuantity(), protein.getComments(), protein.isHasBox(), protein.getWeight(), protein.getSalt(), protein.getCalories(), protein.getFat(), protein.getSugar(), protein.getIngredientItems(), protein.getCountryOfOrigin(), protein.getBrand(), protein.getProtein(), protein.getProductType());
                                    }
                                }
                            }
                            case 8 -> {
                                ...
                                switch (optionMenu) {
                                    case 1 -> {
                                        ...
                                        Drill.insert(drill.getProductID(), drill.getName(), drill.getColor(), drill.getPrice(), drill.getSellerId(), drill.getQuantity(), drill.getComments(), drill.getWeight(), drill.isHasBox(), drill.isSilent(), drill.isChargeable(), drill.getBrand(), drill.getVoltage(), drill.getPowerSource(), drill.getMinSpinSpeed(), drill.getMaxSpinSpeed());
                                    }
                                    case 2 -> {
                                        System.out.println("""
                                                Enter :
                                    ...
                                    case 3 -> {
                                        ...
                                        Spanner.insert(spanner.getProductID(), spanner.getName(), spanner.getColor(), spanner.getPrice(), spanner.getSellerId(), spanner.getQuantity(), spanner.getComments(), spanner.getWeight(), spanner.isHasBox(), spanner.isSilent(), spanner.isChargeable(), spanner.getBrand(), spanner.getSize(), spanner.getStyle(), spanner.getMaterial());
                                    }
                                }
                            }
                            case 9 -> {
                                ...
                                switch (optionMenu) {
                                    case 1 -> {
                                        ...
                                        BoardGames.insert(boardGame.getProductID(), boardGame.getName(), boardGame.getColor(), boardGame.getPrice(), boardGame.getSellerId(), boardGame.getQuantity(), boardGame.getComments(), boardGame.isHasBox(), boardGame.getDifficultyLevel(), boardGame.isMultiplayer(), boardGame.getSize(), boardGame.getPlayerNumber(), boardGame.getTimeToFinish());
                                    }
                                    case 2 -> {
                                        System.out.println("""
                                                Enter :
                                        ...
                                        CardGames.insert(cardGame.getProductID(), cardGame.getName(), cardGame.getColor(), cardGame.getPrice(), cardGame.getSellerId(), cardGame.getQuantity(), cardGame.getComments(), cardGame.isHasBox(), cardGame.getDifficultyLevel(), cardGame.isMultiplayer(), cardGame.getCardNumber(), cardGame.getPlayerNumber(), cardGame.getGangNumber());
                                    }
                                    case 3 -> {
                                        System.out.println("""
                                                Enter :
                                        ...
                                        Puzzles.insert(puzzle.getProductID(), puzzle.getName(), puzzle.getColor(), puzzle.getPrice(), puzzle.getSellerId(), puzzle.getQuantity(), puzzle.getComments(), puzzle.isHasBox(), puzzle.getDifficultyLevel(), puzzle.isMultiplayer(), puzzle.getPartNumber(), puzzle.getFinalPicture());
                                    }
                                }
                            }
                            case 10 -> {
                                ...
                                switch (optionMenu) {
                                    case 1 -> {
                                        ...
                                        shop.addProduct(car);
                                        Car.insert(car.getProductID(), car.getName(), car.getColor(), car.getPrice(), car.getSellerId(), car.getQuantity(), car.getComments(), car.getWeight(), car.getHorsePower(), car.getEngineModel(), car.getWheelNumber(), car.isAutomatic(), car.getMaxSpeed(), car.getBrand(), car.getModel(), car.isRightSteering(), car.getSpeakerModel(), car.getSeatNumber());
                                    }
                                    case 2 -> {
                                        System.out.println("""
                                                Enter :
                                    ...
                                    case 3 -> {
                                        ...
                                        Truck.insert(truck.getProductID(), truck.getName(), truck.getColor(), truck.getPrice(), truck.getSellerId(), truck.getQuantity(), truck.getComments(), truck.getWeight(), truck.getHorsePower(), truck.getEngineModel(), truck.getWheelNumber(), truck.isAutomatic(), truck.getMaxSpeed(), truck.getBrand(), truck.getModel(), truck.getTruckType(), truck.isHasBed());
                                    }
                                }
                            }
                            default -> throw new IllegalStateException("Unexpected value: " + optionMenu);
    ...
    public static void adminPage(Shop shop) {
        ...
        switch (optionMenu) {
            ...
            case 3 -> {
                ...
                Admin.insert(newAdmin.getId(), newAdmin.getUsername(), newAdmin.getPassword(), newAdmin.getAddress());
            }
            case 4 -> {
                System.out.println("""
