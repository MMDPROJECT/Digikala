...
public class EyeBrowMakeUp extends Beauty{
    ...
    public EyeBrowMakeUp(String name, double price, String color, int quantity, MatterState materialState, boolean hasBox, PenType penType, boolean hasWaterResistance, String brand, int longevity) {
