...
public class EyeBrowMakeUp extends Beauty {
    ...
    public static void loadEyeBrowMakeUpFromDatabase(ResultSet rs, Shop shop){
        try {
            ...
            EyeBrowMakeUp newEyeBrowMakeUp = new EyeBrowMakeUp(comments, productID, name, color, price, sellerID, quantity, materialState, hasBox, penType, hasWaterResistance, brand, longevity);
            shop.addProductToShopOnly(newEyeBrowMakeUp);
        } catch (SQLException e) {
            System.out.println(e.getMessage());
        }
    }
